    ...
    public partial class inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductosPresupuestos", x => new { x.ProductoId, x.PresupuestoId });
                    table.ForeignKey(
                        name: "FK_ProductosPresupuestos_Presupuestos_PresupuestoId",
                        column: x => x.PresupuestoId,
                        principalTable: "Presupuestos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductosPresupuestos_Productos_ProductoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductosPresupuestos_PresupuestoId",
                table: "ProductosPresupuestos",
